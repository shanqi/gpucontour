...
/*   printf("rightWidth: %d, rightHeight: %d\n", rightWidth, rightHeight); */
  ...
  if (!tg) {
    ...
    //printf("[computeGraident] check 1\n");
    ...
    //printf("[computeGraident] check 2\n");
    ...
    //printf("[computeGraident] check 3\n");
  } else {
    //printf("[computeGraident] check 4\n");
    ...
    //printf("[computeGraident] check 5\n");
    ...
    //printf("[computeGraident] check 6\n");
 }
}
...
/*   printf("rightWidth: %d, rightHeight: %d\n", rightWidth, rightHeight); */
  ...
  if (nbins == 25) {
    ...
    //printf("[computeGradient_64] check 1, nbins=%d\n", nbins);
    computeGradient<48, 25, true, false><<<gridDim, blockDim>>>(width, height, width * height, border, rotatedWidth, topNorm, bottomNorm, kernelRadius, kernelLength, devIntegrals, integralImagePitchInInts, devGradientA);
    //printf("[computeGradient_64] check 2, nbins=%d\n", nbins);
    computeGradient<48, 25, true, true><<<gridDim, blockDim>>>(width, height, width * height, border, rotatedWidth, leftNorm, rightNorm, kernelRadius, kernelLength, devIntegrals, integralImagePitchInInts, devGradientB);
    //printf("[computeGradient_64] check 3, nbins=%d\n", nbins);
 } else if (nbins == 64) {
    //printf("[computeGradient_64] check 4, nbins=%d\n", nbins);
    ...
    //printf("[computeGradient_64] check 5, nbins=%d\n", nbins);
    ...
    //printf("[computeGradient_64] check 6, nbins=%d\n", nbins);
}
}
